...
为了存一个 8 位数字，我们同时给 8个256位内存一样的地址  
每个地址存 1位  
...
> 每个方格 4 个矩阵    
>    
> 所以一个方格有 32768 个位 （8192 x 4 = 32768）  
> 而一共 32 个方格  
